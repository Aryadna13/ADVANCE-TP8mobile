...
public class HomeConstants {
    ...
    public static final String CONFIRM_BUTTON = "xpath://android.widget.TextView[@text=\"OK\"]";
  ...
  //LogOut
    ...
    public static final String CONFIRM_LOG_OUT_BUTTON ="xpath0://android.widget.Button[@resource-id=\"android:id/button1\"]";
